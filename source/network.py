...
def cnn_model_fn(features,labels,mode):
    ...
    #Logits Layer
    abstractMoves = tf.layers.dense(inputs=faltten_conv12, units=132)
    ...
    onehot_labels = tf.one_hot(indices=tf.cast(labels, tf.uint8), depth=132)
